...
CREATE TABLE `users` (
  ...
  `uPhone` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gender` enum('Male','Female','Other') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `profile_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_verified` tinyint(1) DEFAULT '0',
  `user_role` enum('customer','admin','delivery','owner') COLLATE utf8mb4_unicode_ci DEFAULT 'customer',
...
-- Dump completed on 2025-08-12 15:48:02
