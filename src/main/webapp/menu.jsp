...
<%@ page
    import="java.util.*, com.foodexpress.updatedDTO.MenuItems, com.foodexpress.updatedDTO.Restaurant"%>
<!DOCTYPE html>
<html>
<head>
<title>Menu</title>
...
<body>
    ...
    <div class="restaurant-header">
        ...
        <div class="restaurant-info">
            ...
            <div class="restaurant-meta">
                ...
                <div class="meta-item">
                    ...
                    <div>
                        ...
                        <span class="rating-badge"> <i class="fas fa-star"></i> <%= restaurant.getRating() %> </span>
                        <% } else { %> N/A <% } %>
                    </div>
                </div>
                <div class="meta-item">
                    ...
                    <div>
                        <span class="status-badge <%= statusClass %>">
                            ...
                            <%= restaurant.getStatus() != null ? restaurant.getStatus() : "N/A" %>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="offer-badge"><i class="fas fa-gift"></i> <%= restaurant.getOffer() %></div>
            <% } %>
        </div>
    </div>
    <% } %>
    ...
    <div class="menu-container">
        ...
        <div class="filter-container">
            ...
            <button class="filter-btn" data-filter="veg"><span class="veg-icon"></span> Vegetarian</button>
            <button class="filter-btn" data-filter="nonveg"><span class="nonveg-icon"></span> Non-Vegetarian</button>
        </div>
        ...
        <div class="menu-grid" id="menu-grid">
            ...
            %>
            <%-- <a href="<%= request.getContextPath() %>/CartServlet?restaurantId=<%=restaurant.getRestaurantId()%>" style="text-decoration:none; color:inherit;"> --%>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add-to-cart like functionality with qty control
