...
<style>
    ...
    .details, .summary, .address-section, .payment-section {
        margin-top: 25px;
    }
    .section-title {
        font-size: 20px;
...
<div class="success-container">
    ...
    <div class="details card-section">
        ...
        <p>Order ID: <strong><%= order != null ? order.getOrderId() : "" %></strong></p>
        <p>Total Amount: <strong>₹<%= order != null ? order.getTotalAmount() : "" %></strong></p>
        <p>Placed At: <strong><%= order != null ? order.getPlacedAt().format(DateTimeFormatter.ofPattern("dd MMM yyyy, hh:mm a")) : "" %></strong></p>
        <p>Status: <strong><%= order != null ? order.getStatus() : "" %></strong></p>
    </div>
    ...
    <!-- Delivery Address -->
    <div class="address-section card-section">
        <div class="section-title">Delivery Address</div>
        <p><strong><%= deliveryAddress != null ? deliveryAddress.getLabel() : "" %></strong></p>
        ...
        <div class="order-details-section">
            ...
            <div class="info-grid">
                <div class="info-card" style="text-align: center;">
                    <i class="fas fa-utensils" style="font-size: 30px; color: var(--primary); margin-bottom: 10px;"></i>
                    <div class="info-label">Step 1</div>
                    <div class="info-value">Food Preparation</div>
                    <p style="margin-top: 10px; font-size: 14px;">Our chefs are preparing your delicious meal with fresh ingredients.</p>
                </div>
                
                <div class="info-card" style="text-align: center;">
                    <i class="fas fa-shipping-fast" style="font-size: 30px; color: var(--primary); margin-bottom: 10px;"></i>
                    <div class="info-label">Step 2</div>
                    <div class="info-value">On the Way</div>
                    <p style="margin-top: 10px; font-size: 14px;">Your order will be carefully packaged and dispatched for delivery.</p>
                </div>
                
                <div class="info-card" style="text-align: center;">
                    <i class="fas fa-home" style="font-size: 30px; color: var(--primary); margin-bottom: 10px;"></i>
                    <div class="info-label">Step 3</div>
                    <div class="info-value">Delivery</div>
                    <p style="margin-top: 10px; font-size: 14px;">Expect your order to arrive at your doorstep within the estimated time.</p>
                </div>
            </div>
        </div>
    </div>
